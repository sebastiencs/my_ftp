/*
** get_next_line.c for epitech in /home/chapuis_s/rendu/
**
** Made by chapui_s
** Login   <chapui_s@epitech.eu>
**
** Started on  Mon Mar 16 10:39:06 2015 chapui_s
** Last update Mon Mar 16 19:01:37 2015 chapui_s
*/
...
int		add_str_to(char **dest, char *src)
{
  ...
  while (*dest && (*dest)[i])
    i = i + 1;
  if ((tmp = (char*)malloc(sizeof(char) * (i + strlen(src) + 1))) == NULL)
    return (1);
  i = 0;
  j = 0;
  while (*dest && (*dest)[i])
